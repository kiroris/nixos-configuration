  ...
  config = mkIf cfg.enable {
    wayland.windowManager.hyprland.settings = {
      ...
      bind = [
        ...
        ", XF86AudioLowerVolume, exec, ${audioControl} set-volume @DEFAULT_AUDIO_SINK@ 5%-"
        ", XF86AudioMute, exec, ${audioControl} set-mute @DEFAULT_AUDIO_SINK@ toggle"
        ", XF86AudioMicMute, exec, ${audioControl} set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
      ...
      binde = [
        # Audio
        "SUPER ,V , exec,     ${audioControl} set-volume @DEFAULT_AUDIO_SINK@ 0.5%+"
        "SUPERSHIFT ,V, exec, ${audioControl} set-volume @DEFAULT_AUDIO_SINK@ 0.5%-"
        "SUPER ,M , exec,     ${audioControl} set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
      ];
